...
typedef enum { TAG_FREE, TAG_GENERAL, TAG_BOTLIB, TAG_RENDERER, TAG_SMALL, TAG_STATIC } memtag_t;
...
typedef enum { AXIS_SIDE, AXIS_FORWARD, AXIS_UP, AXIS_ROLL, AXIS_YAW, AXIS_PITCH, MAX_JOYSTICK_AXIS } joystickAxis_t;
...
typedef enum { DT_INFO, DT_WARNING, DT_ERROR, DT_YES_NO, DT_OK_CANCEL } dialogType_t;
