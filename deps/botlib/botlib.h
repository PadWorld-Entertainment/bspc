...
typedef struct aas_export_s {
	...
	int (*AAS_PredictRoute)(struct aas_predictroute_s *route, int areanum, vec3_t origin, int goalareanum,
...
typedef struct ai_export_s {
	...
	int (*BotChooseNBGItem)(int goalstate, vec3_t origin, int *inventory, int travelflags, struct bot_goal_s *ltg,
							float maxtime);
...
"bot_developer"				"0"					be_interface.c		bot developer mode (it's "botDeveloper" in C to
