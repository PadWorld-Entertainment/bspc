...
void AAS_FileInfo(void) {
	...
	optimized = aasworld.numplanes * sizeof(aas_plane_t) + aasworld.numareas * sizeof(aas_area_t) +
				aasworld.numareasettings * sizeof(aas_areasettings_t) + aasworld.numnodes * sizeof(aas_node_t) +
				aasworld.reachabilitysize * sizeof(aas_reachability_t) + aasworld.numportals * sizeof(aas_portal_t) +
				aasworld.numclusters * sizeof(aas_cluster_t);
...
int AAS_LoadAASFile(char *filename) {
	...
	aasworld.areasettings =
		(aas_areasettings_t *)AAS_LoadAASLump(fp, offset, length, &lastoffset, sizeof(aas_areasettings_t));
	...
	aasworld.reachability =
		(aas_reachability_t *)AAS_LoadAASLump(fp, offset, length, &lastoffset, sizeof(aas_reachability_t));
	...
	aasworld.portalindex =
		(aas_portalindex_t *)AAS_LoadAASLump(fp, offset, length, &lastoffset, sizeof(aas_portalindex_t));
